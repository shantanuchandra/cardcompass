...
test('eval lifecycle is idempotent, fenced, bounded, resumable and immutable in PostgreSQL', { skip: !process.env.CONTEXTUAL_EVAL_TEST_ADMIN_URL }, async () => {
  ...
  try {
    ...
    psql(disposable, `
      ...
      insert into public.ai_eval_cases(id,source_feedback_id,feature_key,revision,supersedes_case_id,input_fixture,captured_output,expected_output,operator_feedback,scoring_rubric,severe_failure_conditions,status,approved_in_dataset_version,created_by)
      values ('50000000-0000-4000-8000-000000000002','30000000-0000-4000-8000-000000000001','card_data',2,'50000000-0000-4000-8000-000000000001','{}','{}','{}','revised','{}','{}','approved',2,'10000000-0000-4000-8000-000000000001');`);
