  ...
  try {
    ...
    psql(disposable, `
      ...
      do $$ declare trace jsonb; trace_replay jsonb; first jsonb; replay jsonb; claimed jsonb; stale_token uuid; reviewed jsonb; approved jsonb; revised jsonb; observed timestamptz; begin
        ...
        if public.find_ai_feedback_receipt('10000000-0000-4000-8000-000000000001','20000000-0000-4000-8000-000000000001','recommendation','recommendation_trace',trace->>'id','This recommendation ignored my card',null)->>'id' <> first->>'id' then raise exception 'receipt lookup failed'; end if;
